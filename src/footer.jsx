...
<footer className="footer text-black font-mont bg-customgray p-0 bg-base-200 text-base-content flex md:flex-row flex-col items-center md:my-0 my-1 bg-customgray text-sm md:text-2xl">
  <aside className='basis-2/4 md:my-0justify-center'>
  ...
  <nav className='basis-1/4 flex flex-col md:my-0'>
